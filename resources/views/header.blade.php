...
?>
<nav class="navbar navbar-default fixed-top" style="margin-bottom:0 !important; padding: 10px; background-color: #002147;">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <form action="/search" class="navbar-form navbar-left">
          ...
          <button id="search" class="btn btn-"type="submit" class="btn btn-default">Search</button>
        </form>
